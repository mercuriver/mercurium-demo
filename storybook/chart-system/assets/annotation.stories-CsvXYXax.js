...
}`,...r.parameters?.docs?.source},description:{story:"`hide` / `clamp` / `indicate` policies shown on a reference line that sits outside viewport.",...r.parameters?.docs?.description}}};const x=["AnnotationTypes","Combined","LabelWrapModes","OutOfViewportPolicies"];export{t as AnnotationTypes,a as Combined,o as LabelWrapModes,r as OutOfViewportPolicies,x as __namedExportsOrder,b as default};
