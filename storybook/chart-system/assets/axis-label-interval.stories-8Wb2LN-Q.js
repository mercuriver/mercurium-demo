...
}`,...l.parameters?.docs?.source},description:{story:"Focused — `labelInterval` 을 select 로 직접 조작한다. `commonOptionsFrom` 을 거쳐\nargs → options 로 배선되므로 Storybook controls 가 실제 차트에 반영된다.",...l.parameters?.docs?.description}}};const v=["AllStates","Focused"];export{t as AllStates,l as Focused,v as __namedExportsOrder,u as default};
