...
}`,...t.parameters?.docs?.source},description:{story:"Axis title placements -- 각 축의 title이 렌더되는 위치 조합.\n`xAxis.title` / `yAxis.title` / `yAxis.placement=end` / `xAxis.placement=start` / all-axes.",...t.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
}`,...r.parameters?.docs?.source},description:{story:"Inverted mode -- Line / Bar / Area / Scatter가 inverted:true로 어떻게 렌더되는지.",...r.parameters?.docs?.description}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
    ...commonDefaults,
    xAxisTitle: 'Month',
...
}`,...n.parameters?.docs?.source},description:{story:"Dual Y-Axis + all axis titles -- `yAxis2SeriesKeys` / `yAxis2.title` 조합 interactive.",...n.parameters?.docs?.description}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
    ...commonDefaults,
    inverted: true,
    curve: 'linear',
...
}`,...s.parameters?.docs?.source},description:{story:"Declarative axis format -- `yValuePrefix` / `yValueDecimals` / `yThousandsSeparator` 등 선언형 필드로\n축별 포맷을 제어. 함수형 format 없이도 tooltip 값이 축별 접두/접미/자리수 반영.",...s.parameters?.docs?.description}}};const D=["AxisTitlePlacements","InvertedByChartType","DualYAxisTitles","InvertedDualYAxis","PerAxisFormat","DeclarativeAxisFormat"];export{t as AxisTitlePlacements,s as DeclarativeAxisFormat,n as DualYAxisTitles,r as InvertedByChartType,a as InvertedDualYAxis,i as PerAxisFormat,D as __namedExportsOrder,v as default};
