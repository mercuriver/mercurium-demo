import{c as d}from"./interaction-helpers-CbB0CC5-.js";import{c as g,a as y,d as h,e as m,f,L as u,g as C}from"./story-utils-B9NFoQdo.js";const E={title:"Interactions/Click & Brush",args:{...g,dataset:"numeric-basic"},argTypes:{dataset:C(u),...y}},c={args:{...g,dataset:"numeric-basic"},render:e=>{const{panel:o,log:s}=d(),n=document.createElement("div");n.style.cssText="display:flex;flex-direction:column;gap:12px;";const a=h("line",f(u,e.dataset),{...m(e)},{fitContainer:e.fitContainer,width:e.width??600,height:e.height??360,plugins:["click"],onEngine:i=>{i.on("point:click",t=>{s(`[click] series="${t.seriesKey}" index=${t.pointIndex} x=${JSON.stringify(t.dataPoint.x)} y=${t.dataPoint.y} px=(${Math.round(t.pixelX)}, ${Math.round(t.pixelY)})`)})}});return n.appendChild(a),n.appendChild(o),n}},l={parameters:{controls:{disable:!0}},render:e=>{const o={xAxisType:"number",series:[{key:"group-a",label:"Group A",data:Array.from({length:20},(t,r)=>({x:r*37%100,y:(r*51+10)%100}))}]},{panel:s,log:n}=d(),a=document.createElement("div");a.style.cssText="display:flex;flex-direction:column;gap:12px;";const i=h("scatter",o,{frameTheme:e.frameTheme,scatter:{dotSize:6},tooltip:{show:!0}},{width:600,height:360,plugins:["click"],onEngine:t=>{t.on("point:click",r=>{n(`[click] idx=${r.pointIndex} x=${r.dataPoint.x} y=${r.dataPoint.y}`)})}});return a.appendChild(i),a.appendChild(s),a}},p={args:{...g,dataset:"numeric-large"},render:e=>{const{panel:o,log:s}=d(),n=document.createElement("div");n.style.cssText="display:flex;flex-direction:column;gap:12px;";let a=null;const i=document.createElement("button");i.textContent="Clear brush",i.style.cssText="align-self:flex-start;padding:6px 12px;font-size:12px;border:1px solid #cbd5e1;background:#fff;border-radius:4px;cursor:pointer;",i.addEventListener("click",()=>{a?.emit("brush:clear",void 0),s("[brush:clear]")});const t=h("line",f(u,e.dataset),{...m(e)},{fitContainer:e.fitContainer,width:e.width??700,height:e.height??380,plugins:["brush"],onEngine:r=>{a=r,r.on("brush:select",x=>{s(`[brush:select] xMin=${JSON.stringify(x.xMin)} xMax=${JSON.stringify(x.xMax)}`)}),r.on("brush:clear",()=>{s("[brush:clear]")})}});return n.appendChild(i),n.appendChild(t),n.appendChild(o),n}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
    ...commonDefaults,
