...
}`,...p.parameters?.docs?.source},description:{story:"Brush 범위 선택 -- Shift+드래그로 X 범위 선택, clear 버튼으로 해제.",...p.parameters?.docs?.description}}};const T=["ClickBasic","ClickScatter","BrushBasic"];export{p as BrushBasic,c as ClickBasic,l as ClickScatter,T as __namedExportsOrder,k as default};
