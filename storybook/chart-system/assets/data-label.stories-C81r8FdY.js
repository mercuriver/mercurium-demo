import{c as r,d as c,f as s,g as d,b as p,r as h}from"./story-utils-CJT9BIct.js";import"./style-CugFjfBU.js";import"./option-to-id-BJrSKRCI.js";const l={xAxisType:"number",series:[{key:"edge",label:"Edge Values",data:[{x:0,y:5},{x:1,y:95},{x:2,y:50},{x:3,y:10},{x:4,y:90},{x:5,y:3}]}]},m={xAxisType:"category",series:[{key:"sales",label:"Sales",data:[{x:"Jan",y:120},{x:"Feb",y:135},{x:"Mar",y:128},{x:"Apr",y:145},{x:"May",y:132},{x:"Jun",y:150}]}]},y={title:"Options/Data Label",args:{...r,showDataLabel:!0,dataLabelBackground:!0,chartType:"bar"},argTypes:{chartType:{control:"select",options:["line","bar","scatter"],description:"차트 유형",table:{defaultValue:{summary:"bar"},category:"Common"}},...c}},a={parameters:{controls:{disable:!0}},render:t=>h([{rotation:0,position:"top",label:"rotation 0 · top"},{rotation:-45,position:"top",label:"rotation -45 · top"},{rotation:-90,position:"top",label:"rotation -90 · top"},{rotation:0,position:"inside",label:"rotation 0 · inside"},{rotation:0,position:"bottom",label:"rotation 0 · bottom"},{rotation:45,position:"top",label:"rotation 45 · top"}].map(i=>({type:"bar",data:m,options:{frameTheme:t.frameTheme,dataLabel:{show:!0,rotation:i.rotation,position:i.position,background:!0}},label:i.label})),{columns:3,cardHeight:240,hideDataSummary:!0})},e={args:{...r,chartType:"line",showDataLabel:!0,dataLabelBackground:!0,dataLabelBorderRadius:8,dataLabelPadding:6},render:t=>s(t.chartType,l,{...d(t)},{fitContainer:t.fitContainer,width:t.width??600,height:t.height??360})},o={args:{...r,chartType:"line",showDataLabel:!0,dataLabelBackground:!0,dataLabelOverflow:"allow",dataLabelCrop:!0},render:t=>s(t.chartType,l,{...d(t)},{fitContainer:t.fitContainer,width:t.width??600,height:t.height??360})},n={name:"Dual Y-Axis + Data Labels",args:{...r,showDataLabel:!0,dataLabelBackground:!0,curve:"smooth",showDots:!0,width:700,yAxis2SeriesKeys:"margin",yAxis2Title:"Profit Margin (%)",tooltipShared:!0},render:t=>s("line",p,{...d(t),line:{curve:t.curve,dots:t.showDots}},{fitContainer:t.fitContainer,width:t.width,height:t.height})};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
}`,...n.parameters?.docs?.source}}};const D=["PositionAndRotation","BorderRadiusAndPadding","OverflowHandling","DualYAxisWithDataLabels"];export{e as BorderRadiusAndPadding,n as DualYAxisWithDataLabels,o as OverflowHandling,a as PositionAndRotation,D as __namedExportsOrder,y as default};
