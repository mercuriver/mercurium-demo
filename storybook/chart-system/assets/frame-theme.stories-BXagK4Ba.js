import{a as s,c as l,b as o,E as i,N as n}from"./story-utils-B9NFoQdo.js";const d={title:"Options/Frame Theme",parameters:{syncTheme:!1},args:{...l},argTypes:{...s}},e={parameters:{controls:{disable:!0}},render:()=>o([{type:"line",data:n,options:{frameTheme:"light",backgroundColor:"#ffffff",legend:{show:!0},tooltip:{show:!0},crosshair:{show:!0,type:"x"}},label:"Light preset"},{type:"line",data:n,options:{frameTheme:"dark",backgroundColor:"#0a0a0a",legend:{show:!0},tooltip:{show:!0},crosshair:{show:!0,type:"x"}},label:"Dark preset"}],{columns:2,cardHeight:320,hideDataSummary:!0})},r={parameters:{controls:{disable:!0}},render:()=>o([{theme:"light",status:"no-data",label:"Light · No data"},{theme:"light",status:"error",label:"Light · Error"},{theme:"dark",status:"no-data",label:"Dark · No data"},{theme:"dark",status:"error",label:"Dark · Error"}].map(a=>({type:"line",data:i,options:{frameTheme:a.theme,legend:{show:!1},tooltip:{show:!1},crosshair:{show:!1}},label:a.label,onEngine:t=>{requestAnimationFrame(()=>{a.status==="no-data"?t.getChartContainer().showStatus("no-data"):t.getChartContainer().showStatus("error","Simulated error message")})}})),{columns:2,cardHeight:260,hideDataSummary:!0})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
