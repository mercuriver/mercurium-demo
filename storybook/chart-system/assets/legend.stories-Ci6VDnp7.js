...
}`,...s.parameters?.docs?.source},description:{story:"Long label 말줄임 -- `legendItemMaxWidth: 120` 로 긴 시리즈 라벨이 ellipsis 처리.\n잘린 라벨에 hover 하면 `title` attribute로 원문 확인.",...s.parameters?.docs?.description}}};const S=["PositionModes","OverflowControls","EmptyLegend","LongLabelTruncation"];export{a as EmptyLegend,s as LongLabelTruncation,r as OverflowControls,n as PositionModes,S as __namedExportsOrder,C as default};
