import{c as i,a as u,d as c,e as l,f as o,L as a,b as h,g as p}from"./story-utils-B9NFoQdo.js";const f={title:"Chart Types/Line",args:{...i,dataset:"numeric-basic"},argTypes:{...u,dataset:p(a),curve:{control:"select",options:["linear","smooth","step"],description:"선 보간 방식",table:{defaultValue:{summary:"linear"}}},dots:{control:"boolean",description:"데이터 포인트 표시",table:{defaultValue:{summary:"false"}}},lineWidth:{control:{type:"range",min:1,max:5,step:.5},description:"선 두께",table:{defaultValue:{summary:"2"}}}}},t={parameters:{controls:{disable:!0}},render:e=>h(["linear","smooth","step"].flatMap(d=>[!1,!0].map(m=>({type:"line",data:o(a,"numeric-basic"),options:{frameTheme:e.frameTheme,line:{curve:d,dots:m,width:2}},label:`${d[0].toUpperCase()}${d.slice(1)} · Dots ${m?"on":"off"}`}))),{columns:3,cardHeight:240,hideDataSummary:!0})},n={args:{...i,dataset:"numeric-multi",curve:"smooth",lineWidth:1.5,dots:!0,width:700},render:e=>c("line",o(a,e.dataset),{...l(e),line:{curve:e.curve,dots:e.dots,width:e.lineWidth}},{fitContainer:e.fitContainer,width:e.width,height:e.height})},r={args:{...i,dataset:"category-basic",curve:"linear",lineWidth:2,dots:!0},render:e=>c("line",o(a,e.dataset),{...l(e),line:{curve:e.curve,dots:e.dots,width:e.lineWidth}},{fitContainer:e.fitContainer,width:e.width,height:e.height})},s={name:"Data Labels + Background",args:{...i,dataset:"numeric-basic",curve:"linear",lineWidth:2,dots:!0,showDataLabel:!0,dataLabelBackground:!0},render:e=>c("line",o(a,e.dataset),{...l(e),line:{curve:e.curve,dots:e.dots,width:e.lineWidth}},{fitContainer:e.fitContainer,width:e.width,height:e.height})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
