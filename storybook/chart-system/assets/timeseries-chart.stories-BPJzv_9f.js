import{c as d,a as u,d as m,e as h,f as r,T as t,b as c,g as p}from"./story-utils-B9NFoQdo.js";const g={title:"Chart Types/Timeseries",args:{...d,width:700,dataset:"date-daily"},argTypes:{...u,dataset:p(t),curve:{control:"select",options:["linear","smooth","step"],description:"선 보간 방식",table:{defaultValue:{summary:"smooth"}}},dots:{control:"boolean",description:"데이터 포인트 표시",table:{defaultValue:{summary:"false"}}}}},a={parameters:{controls:{disable:!0}},render:e=>c([{type:"timeseries",data:r(t,"date-large"),options:{frameTheme:e.frameTheme,line:{curve:"linear",dots:!0}},label:"Hourly (large dataset)"},{type:"timeseries",data:r(t,"date-daily"),options:{frameTheme:e.frameTheme,line:{curve:"smooth"}},label:"Daily"},{type:"timeseries",data:r(t,"date-monthly"),options:{frameTheme:e.frameTheme,line:{curve:"linear",dots:!0}},label:"Monthly"}],{columns:3,cardHeight:260,hideDataSummary:!0})},n={parameters:{controls:{disable:!0}},render:e=>{const i=r(t,"date-monthly"),l={frameTheme:e.frameTheme,grid:{show:!0},legend:{show:!0,position:"top"},tooltip:{show:!0}};return c([{type:"line",data:i,options:{...l,line:{curve:"smooth",dots:!0}},label:"Line"},{type:"area",data:i,options:{...l,area:{opacity:.3},line:{curve:"smooth"}},label:"Area"},{type:"timeseries",data:i,options:{...l,line:{curve:"smooth",dots:!0}},label:"Timeseries"}],{columns:3,cardHeight:260,hideDataSummary:!0})}},s={args:{...d,dataset:"date-daily",curve:"smooth",dots:!1,colorPalette:"vintage-press",showCrosshair:!0,crosshairType:"both",crosshairColor:"hsla(215, 31%, 16%, 1)",crosshairDashStyle:"solid"},render:e=>m("timeseries",r(t,e.dataset),{...h(e),line:{curve:e.curve,dots:e.dots}},{fitContainer:e.fitContainer,width:e.width,height:e.height})},o={args:{...d,dataset:"date-large",curve:"linear",dots:!1},render:e=>m("timeseries",r(t,e.dataset),{...h(e),line:{curve:e.curve,dots:e.dots}},{fitContainer:e.fitContainer,width:e.width,height:e.height})};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
