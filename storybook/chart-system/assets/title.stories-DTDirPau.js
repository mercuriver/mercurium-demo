import{c as p,a as g,f as u,b as m,e as b,d as f,L as r,g as T}from"./story-utils-B9NFoQdo.js";const v={title:"Options/Title",args:{...p,dataset:"multi",titleText:"Revenue by Quarter",subtitleText:"FY2025 actuals (KRW)",showSubtitle:!0,titleAlign:"center",titlePosition:"top"},argTypes:{dataset:T(r),showSubtitle:{control:"boolean",description:"Subtitle 표시 여부",table:{defaultValue:{summary:"true"},category:"Title"}},...g}},h=["top","right","bottom","left"],i={parameters:{controls:{disable:!0}},render:t=>{const n=u(r,"multi");return m(["left","center","right"].map(e=>({type:"line",data:n,options:{frameTheme:t.frameTheme,title:{text:"Revenue by Quarter",align:e},subtitle:{text:"FY2025 actuals (KRW)",align:e},line:{curve:"smooth",width:2}},label:`align: ${e}`})),{columns:3,cardHeight:260,hideDataSummary:!0})}},o={parameters:{controls:{disable:!0}},render:t=>{const n=u(r,"multi");return m(h.map(e=>({type:"line",data:n,options:{frameTheme:t.frameTheme,title:{text:"Revenue by Quarter",position:e,align:"center"},subtitle:{text:"FY2025 actuals",align:"center"},line:{curve:"smooth",width:2}},label:`position: ${e}`})),{columns:2,cardHeight:260,hideDataSummary:!0})}},S=[{label:"legend: top",options:{legend:{show:!0,position:"top"}}},{label:"legend: left",options:{legend:{show:!0,position:"left"}}},{label:"legend: hidden",options:{legend:{show:!1}}}],l={parameters:{controls:{disable:!0}},render:t=>{const n=u(r,"multi"),e=[];for(const a of S)for(const s of h)e.push({type:"line",data:n,options:{frameTheme:t.frameTheme,title:{text:"Revenue by Quarter",position:s,align:"center"},subtitle:{text:"FY2025 actuals",align:"center"},line:{curve:"smooth",width:2},...a.options},label:`title=${s} / ${a.label}`});return m(e,{columns:4,cardHeight:240,hideDataSummary:!0})}},c={parameters:{controls:{disable:!0}},render:t=>{const n=u(r,"multi"),e=[];for(const a of["left","right"])for(const s of["left","center","right"])e.push({type:"line",data:n,options:{frameTheme:t.frameTheme,title:{text:"Monthly Active Users",position:a,align:s},subtitle:{text:"Last 90 days",align:s},line:{curve:"smooth",width:2}},label:`position: ${a} / align: ${s}`});return m(e,{columns:3,cardHeight:260,hideDataSummary:!0})}},d={args:{...p,dataset:"multi",titleText:"Monthly Active Users",subtitleText:"Last 90 days",showSubtitle:!0,titleAlign:"left",titlePosition:"top",width:720,height:360},render:t=>{const n=b(t),e=t.showSubtitle?n:{...n,subtitle:void 0};return f("line",u(r,t.dataset),{...e,line:{curve:"smooth",width:2}},{fitContainer:t.fitContainer,width:t.width,height:t.height})}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
