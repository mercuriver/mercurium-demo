...
corner 버튼이 렌더된다. 버튼 클릭 시 양축 viewport 가 초기화된다.`,...v.parameters?.docs?.description}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
}`,...y.parameters?.docs?.source},description:{story:`Visual sanity check for all four navigator position combinations. Each
...
width, nav height == plot height) hold regardless of orientation.`,...y.parameters?.docs?.description}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
}`,...f.parameters?.docs?.source},description:{story:`Layer toggle matrix — \`xNavigator\` / \`yNavigator\` 의 thumbnail / sparkline /
...
조합 정의:
  ...
  4. all layers          (X: t+s+d, Y: t+d)`,...f.parameters?.docs?.description}}};w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
