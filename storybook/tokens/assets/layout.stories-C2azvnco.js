    ...
    fontFamily: 'system-ui, sans-serif'
      ...
      gap: 8
        ...
        gap: 16
          ...
          height: 24,
          background: value < 0 ? 'var(--color-state-danger-default, #ef4444)' : value === 0 ? 'var(--color-text-disabled, #94a3b8)' : 'var(--color-primary-color, #0ea5e9)',
          borderRadius: 4
        }} />
              <span style={{
          fontSize: 12,
