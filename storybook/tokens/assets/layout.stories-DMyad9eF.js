    ...
    fontFamily: 'system-ui, sans-serif'
      ...
      gap: 8
        ...
        gap: 16
          ...
          width: value,
          height: 24,
          background: 'var(--color-primary-color, #0ea5e9)',
          borderRadius: 4
        }} />
            <span style={{
          fontSize: 12,
    ...
    fontFamily: 'system-ui, sans-serif'
      ...
      gap: 24
        ...
        textAlign: 'center'
          ...
          height: 80,
          background: 'var(--color-surface-subtle, #fff)',
          border: \`\${value} solid var(--color-primary-color, #0ea5e9)\`,
          borderRadius: 8,
          marginBottom: 8
        }} />
            <div style={{
...
}`,...f.parameters?.docs?.source}}};const I=["Spacing","Radius","Shadow","Presets","ZIndex","BorderWidth"];export{f as BorderWidth,c as Presets,s as Radius,l as Shadow,a as Spacing,p as ZIndex,I as __namedExportsOrder,k as default};
