import{j as e,r as b}from"./iframe-Dr7tdnDG.js";import{B as t}from"./Button-DMheubLd.js";import{I as d,b as S,n as w,t as A,e as O,f as F,h as P}from"./index-BZkHnGtK.js";import{s as p,a as r,r as i}from"./story-helpers-CZYtc2RC.js";import"./preload-helper-PPVm8Dsz.js";import"./use-machine-Df02H652.js";import"./use-interaction-state-BxPjOGDk.js";const E={title:"Components/Button",component:t,tags:["autodocs"],parameters:{docs:{description:{component:`
...
}`,...f.parameters?.docs?.source},description:{story:"아이콘 토글 버튼 — 활성/비활성 상태를 시각적으로 구분하는 패턴.\n\n`ghost` shape 버튼에 `aria-pressed`로 토글 상태를 전달하고,\n활성 상태일 때 `backgroundColor`과 `color`를 변경하여 구분합니다.\n`Tooltip`과 함께 사용하여 버튼의 기능을 설명합니다.\n\n사용 예: Auto-save 토글, 필터 활성화, 패널 열기/닫기",...f.parameters?.docs?.description}}};const R=["Playground","AllStates","Disabled","Loading","ShapeIntentMatrix","IconShapes","RecommendedCombinations","LoadingStates","Sizes","IconToggle"];export{h as AllStates,m as Disabled,v as IconShapes,f as IconToggle,g as Loading,B as LoadingStates,u as Playground,x as RecommendedCombinations,y as ShapeIntentMatrix,j as Sizes,R as __namedExportsOrder,E as default};
