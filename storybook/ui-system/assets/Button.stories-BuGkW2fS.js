import{j as e,r as j}from"./iframe-CIISAoEK.js";import{B as t}from"./Button-C4Mw6Wig.js";import{I as z,c as T,f as A,a as k}from"./Icon-DrkRNV24.js";import{s as x,a as r,r as n}from"./story-helpers-CZYtc2RC.js";import"./preload-helper-PPVm8Dsz.js";import"./index-J-6yexAb.js";import"./use-machine-CAv56gvN.js";import"./use-interaction-state-CFpnGT6F.js";const H={title:"Components/Button",component:t,tags:["autodocs"],parameters:{docs:{description:{component:`
...
}`,...v.parameters?.docs?.source},description:{story:"아이콘 토글 버튼 — 활성/비활성 상태를 시각적으로 구분하는 패턴.\n\n`ghost` shape 버튼에 `aria-pressed`로 토글 상태를 전달하고,\n활성 상태일 때 `backgroundColor`과 `color`를 변경하여 구분합니다.\n`Tooltip`과 함께 사용하여 버튼의 기능을 설명합니다.\n\n사용 예: Auto-save 토글, 필터 활성화, 패널 열기/닫기",...v.parameters?.docs?.description}}};const M=["Playground","AllStates","Disabled","Loading","ShapeIntentMatrix","RecommendedCombinations","LoadingStates","Sizes","IconToggle"];export{c as AllStates,p as Disabled,v as IconToggle,u as Loading,g as LoadingStates,d as Playground,m as RecommendedCombinations,h as ShapeIntentMatrix,y as Sizes,M as __namedExportsOrder,H as default};
