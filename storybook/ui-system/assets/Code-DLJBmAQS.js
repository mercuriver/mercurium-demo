import{R as f,by as R,j as m,bz as h,bA as v}from"./iframe-D_UqZR7W.js";const y=f.forwardRef(({level:e="1",weight:t,align:a,color:n="default",truncate:s=!1,as:l,className:d,style:o,children:i,...r},p)=>{const u=l||`h${e}`,c=R({size:e,weight:t,align:a,color:n,truncate:s});return m.jsx(u,{ref:p,className:d,style:{...c,...o},...r,children:i})});y.displayName="Heading";y.__docgenInfo={description:`Heading 컴포넌트
...
@default 'p'`,defaultValue:{value:"'p'",computed:!1}},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}},composes:["Omit"]};const g=f.forwardRef(({size:e="md",variant:t="soft",color:a="default",as:n="code",className:s,style:l,children:d,...o},i)=>{const r=n,u=v({size:e,variant:t,color:a});return m.jsx(r,{ref:i,className:s,style:{...u,...l},...o,children:d})});g.displayName="Code";g.__docgenInfo={description:`Code 컴포넌트
