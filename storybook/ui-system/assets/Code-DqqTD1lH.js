import{R as c,ck as R,j as f,cl as g,cm as q}from"./iframe-DUusFeTx.js";const m=c.forwardRef(({level:e="1",weight:a,align:t,color:d="default",truncate:s=!1,as:l,className:o,children:n,...r},i)=>{const u=l||`h${e}`,p=[R({size:e,weight:a,align:t,color:d,truncate:s}),o].filter(Boolean).join(" ");return f.jsx(u,{ref:i,className:p,...r,children:n})});m.displayName="Heading";m.__docgenInfo={description:`Heading 컴포넌트
...
@default 'p'`,defaultValue:{value:"'p'",computed:!1}},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}},composes:["Omit"]};const y=c.forwardRef(({size:e="md",variant:a="soft",color:t="default",as:d="code",className:s,children:l,...o},n)=>{const r=d,i=[q({size:e,variant:a,color:t}),s].filter(Boolean).join(" ");return f.jsx(r,{ref:n,className:i,...o,children:l})});y.displayName="Code";y.__docgenInfo={description:`Code 컴포넌트
