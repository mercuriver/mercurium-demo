import{j as e,R as h}from"./iframe-B352m8Ic.js";import{R as a}from"./Radio-LuoU5QSS.js";import{c as r,a as o,r as k}from"./story-helpers-CZYtc2RC.js";import"./preload-helper-PPVm8Dsz.js";import"./use-toggle-C00XK3Xa.js";import"./use-machine-D8fwiq3C.js";import"./use-machine-sync-CSenzpo8.js";const j={title:"Components/Radio",component:a,tags:["autodocs"],argTypes:{variant:{control:"select",options:["danger","warning"],description:"의미적 상태 variant (라디오 색상 변경, 미선택 시 border에도 적용)",table:{type:{summary:"StatusVariant"}}},checked:{control:"boolean",description:"제어 모드에서 현재 선택 상태",table:{type:{summary:"boolean"}}},onCheckedChange:{description:"선택 상태 변경 시 호출되는 콜백",table:{type:{summary:"(checked: boolean) => void"}}}}},s={args:{label:"Option A",checked:!1,disabled:!1}},d={parameters:{controls:{disable:!0}},render:()=>e.jsxs("div",{style:r,children:[e.jsxs("div",{children:[e.jsx("h4",{style:o,children:"States"}),e.jsxs("div",{style:r,children:[e.jsx(a,{label:"Unchecked",checked:!1}),e.jsx(a,{label:"Checked",checked:!0}),e.jsx(a,{label:"Unchecked Disabled",checked:!1,disabled:!0}),e.jsx(a,{label:"Checked Disabled",checked:!0,disabled:!0})]})]}),e.jsxs("div",{children:[e.jsx("h4",{style:o,children:"Variants"}),e.jsxs("div",{style:r,children:[e.jsx(a,{label:"Warning",variant:"warning",checked:!1}),e.jsx(a,{label:"Warning (Checked)",variant:"warning",checked:!0}),e.jsx(a,{label:"Danger",variant:"danger",checked:!1}),e.jsx(a,{label:"Danger (Checked)",variant:"danger",checked:!0})]})]})]})},n={render:()=>e.jsxs("div",{style:r,children:[e.jsx(a,{label:"Option A"}),e.jsx(a,{label:"Option B",checked:!0}),e.jsx(a,{label:"Option C"})]})},c={render:()=>e.jsxs("div",{style:k,children:[e.jsx(a,{checked:!1}),e.jsx(a,{checked:!0}),e.jsx(a,{checked:!1,disabled:!0})]})},t={render:()=>{const[l,i]=h.useState(!1);return e.jsxs("div",{style:r,children:[e.jsx(a,{label:"Controlled Radio",checked:l,onCheckedChange:i}),e.jsxs("p",{children:["Current state: ",l?"Checked":"Unchecked"]})]})}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    label: 'Option A',
    checked: false,
    disabled: false
