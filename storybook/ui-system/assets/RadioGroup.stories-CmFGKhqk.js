  ...
  render: () => {
    ...
    return <div style={column}>
        ...
        <div>
          ...
          <p>
            Selected User Name: <strong>{selectedUser?.userName}</strong>
          </p>
        </div>
      </div>;
  }
