import{j as s,r as T}from"./iframe-B352m8Ic.js";import{T as v,u as n}from"./use-toast-nvJhaQsz.js";import{B as t}from"./Button-Dn8y6vOd.js";import{S as C}from"./SegmentedControl-QpOiT8R2.js";import{s as A,a as x,r as a,c as f}from"./story-helpers-CZYtc2RC.js";import"./preload-helper-PPVm8Dsz.js";import"./use-machine-D8fwiq3C.js";import"./index-CoG5Onai.js";import"./index-BQaWQ9Wz.js";import"./vanilla-extract-dynamic.esm-BUlnp6I2.js";import"./Icon-DJDVo0me.js";import"./intent-icon-27e4nV0q.js";import"./Tooltip-EMnZcfWy.js";import"./use-merged-ref-C5T0hISp.js";import"./use-popup-close-Bk1BnKz0.js";import"./use-machine-sync-CSenzpo8.js";const J={title:"Components/Toast",tags:["autodocs"],parameters:{docs:{description:{component:`
...
\`\`\`
        `}}},decorators:[(e,o)=>{const i=o.args.position??"top-right";return s.jsx(v,{position:i,maxCount:5,children:s.jsx(e,{})})}],argTypes:{position:{control:"select",options:["top-left","top-center","top-right","bottom-left","bottom-center","bottom-right"],description:"토스트 표시 위치",table:{type:{summary:"ToastPosition"},defaultValue:{summary:"top-right"}}}}};function k(){const e=n();return s.jsx("div",{style:{...f,padding:"24px"},children:s.jsxs("div",{style:a,children:[s.jsx(t,{onClick:()=>e.info("This is an info message"),children:"Info"}),s.jsx(t,{onClick:()=>e.success("Operation completed successfully"),children:"Success"}),s.jsx(t,{onClick:()=>e.warning("Please check your input"),children:"Warning"}),s.jsx(t,{onClick:()=>e.danger("An error occurred"),children:"Danger"})]})})}const c={args:{position:"top-right"},render:()=>s.jsx(k,{})};function S(){const e=n(),o=()=>{e.info("Info: 일반 정보 메시지입니다"),e.success("Success: 작업이 완료되었습니다"),e.warning("Warning: 주의가 필요합니다"),e.danger("Danger: 오류가 발생했습니다")};return s.jsx("div",{style:{padding:"24px"},children:s.jsx(t,{onClick:o,children:"Show All Types"})})}const l={args:{position:"top-right"},render:()=>s.jsx(S,{})};function P(){const e=n(),o=()=>{e.show({message:"This toast requires user action to dismiss",type:"info",duration:0,showClose:!1,showProgress:!1,action:{label:"Confirm",onClick:()=>{}},cancelAction:{label:"Cancel",onClick:()=>{}}})};return s.jsx("div",{style:{padding:"24px"},children:s.jsx(t,{onClick:o,children:"Show Persistent Toast"})})}const d={args:{position:"top-right"},render:()=>s.jsx(P,{})};function D(){const e=n(),o=()=>{e.show({message:"File has been deleted",type:"warning",duration:8e3,action:{label:"Undo",onClick:()=>e.success("Restored")}})},i=()=>{e.show({title:"Recover Previous Work",message:"Would you like to restore the previous session?",type:"info",duration:0,showProgress:!1,showClose:!1,action:{label:"Restore",onClick:()=>e.success("Session restored")},cancelAction:{label:"Discard",onClick:()=>e.info("Session discarded")}})};return s.jsxs("div",{style:{...a,padding:"24px"},children:[s.jsx(t,{onClick:o,children:"Undo Action"}),s.jsx(t,{onClick:i,children:"Confirm Toast"})]})}const p={args:{position:"top-right"},render:()=>s.jsx(D,{})};function b(){const e=n();return s.jsxs("div",{style:{...a,padding:"24px"},children:[s.jsx(t,{onClick:()=>e.info("2 seconds",{duration:2e3}),children:"2s"}),s.jsx(t,{onClick:()=>e.info("5 seconds (default)",{duration:5e3}),children:"5s"}),s.jsx(t,{onClick:()=>e.info("10 seconds",{duration:1e4}),children:"10s"})]})}const h={args:{position:"top-right"},render:()=>s.jsx(b,{})};function W(){const e=n();return s.jsxs("div",{style:{...a,padding:"24px"},children:[s.jsx(t,{onClick:()=>e.info("Your changes have been saved automatically.",{title:"Auto Saved"}),children:"Info with Title"}),s.jsx(t,{onClick:()=>e.success("All 12 rows have been imported successfully.",{title:"Import Complete"}),children:"Success with Title"}),s.jsx(t,{onClick:()=>e.warning("Some columns have missing values.",{title:"Data Warning"}),children:"Warning with Title"}),s.jsx(t,{onClick:()=>e.danger("Unable to connect to the server.",{title:"Connection Error"}),children:"Danger with Title"}),s.jsx(t,{shape:"outline",onClick:()=>e.info("This toast has no title for comparison."),children:"Without Title"})]})}const u={args:{position:"top-right"},render:()=>s.jsx(W,{})};function B(){const e=n();let o=0;const i=()=>{o++,e.info(`Toast #${o}`)};return s.jsxs("div",{style:{...a,padding:"24px"},children:[s.jsx(t,{onClick:i,children:"Add Toast"}),s.jsx(t,{shape:"ghost",onClick:()=>e.dismissAll(),children:"Dismiss All"})]})}const m={parameters:{controls:{disable:!0}},render:()=>{function e(){const o=n(),i=["info","success","warning","danger"];return s.jsxs("div",{style:A,children:[s.jsxs("div",{children:[s.jsx("h4",{style:x,children:"Type variants"}),s.jsx("div",{style:a,children:i.map(r=>s.jsx(t,{size:"sm",onClick:()=>o[r](`${r} message`),children:r},r))})]}),s.jsxs("div",{children:[s.jsx("h4",{style:x,children:"With title"}),s.jsx("div",{style:a,children:i.map(r=>s.jsxs(t,{size:"sm",shape:"outline",onClick:()=>o.show({type:r,title:"Title",message:`${r} with title`}),children:[r," + title"]},r))})]}),s.jsxs("div",{children:[s.jsx("h4",{style:x,children:"Persistent (duration=0)"}),s.jsx(t,{size:"sm",onClick:()=>o.show({type:"warning",message:"Persistent toast",duration:0}),children:"Show persistent"})]}),s.jsxs("div",{children:[s.jsx("h4",{style:x,children:"With renderActions"}),s.jsx(t,{size:"sm",onClick:()=>o.show({type:"info",title:"Custom action slot",message:"renderActions replaces the default action buttons.",showProgress:!1,renderActions:s.jsx(C,{items:[{value:"a",label:"Option A"},{value:"b",label:"Option B"}],value:"a",onChange:()=>{},size:"sm"})}),children:"Show with renderActions"})]})]})}return s.jsx(v,{position:"top-right",children:s.jsx(e,{})})}},y={args:{position:"top-right"},render:()=>s.jsx(B,{})};function z(){const e=n(),[o,i]=T.useState("navigator"),r=[{value:"navigator",label:"Use Navigator"},{value:"all",label:"Show All"}],j=()=>{e.show({title:"Large dataset detected",message:"Category axis has 120+ items. Choose how to display this chart.",type:"info",showClose:!0,showProgress:!1,renderActions:s.jsx(C,{items:r,value:o,onChange:w=>i(w),size:"sm"})})};return s.jsxs("div",{style:{...f,padding:"24px"},children:[s.jsx("div",{style:a,children:s.jsx(t,{onClick:j,children:"Show Density Overflow Toast"})}),s.jsxs("div",{style:{fontSize:14},children:["Current view: ",s.jsx("strong",{children:o})]})]})}const g={args:{position:"top-right"},render:()=>s.jsx(z,{})};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
    position: 'top-right'
  },
  render: () => <ToastDemo />
...
}`,...g.parameters?.docs?.source},description:{story:'`renderActions` escape hatch: SegmentedControl 같이 "어느 쪽이 선택되어 있는가" 를\n표현해야 하는 상호작용을 Toast 액션 영역에 주입합니다.\n\n규칙:\n- `action` / `cancelAction` 과 mutually exclusive -- 동시 제공 시 기본 버튼 무시.\n- duration 기반 자동 닫힘 비활성 (persistent 강제). 닫기 버튼 또는 `dismiss(id)` 필요.\n- 선택 상태는 caller 가 소유 (여기서는 `useState`). Toast 는 단순 slot.',...g.parameters?.docs?.description}}};const K=["Playground","AllTypes","Persistent","WithActions","CustomDuration","WithTitle","AllStates","MaxCount","WithRenderActions"];export{m as AllStates,l as AllTypes,h as CustomDuration,y as MaxCount,d as Persistent,c as Playground,p as WithActions,g as WithRenderActions,u as WithTitle,K as __namedExportsOrder,J as default};
