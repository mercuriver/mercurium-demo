import{j as s,r as T}from"./iframe-Dr7tdnDG.js";import{T as v,u as n}from"./use-toast-BWNfNt3H.js";import{B as t}from"./Button-DMheubLd.js";import{S as C}from"./SegmentedControl-C2lmEmar.js";import{s as A,a as x,r as a,c as f}from"./story-helpers-CZYtc2RC.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Lz4CA8Cu.js";import"./index-Bqlosw6n.js";import"./use-machine-Df02H652.js";import"./index-BZkHnGtK.js";import"./Tooltip-J4neSWo2.js";import"./use-popup-close-DzUpYJgy.js";import"./use-merged-ref-ZOu2dXhq.js";import"./use-interaction-state-BxPjOGDk.js";const Y={title:"Components/Toast",tags:["autodocs"],parameters:{docs:{description:{component:`
...
}`,...g.parameters?.docs?.source},description:{story:'`renderActions` escape hatch: SegmentedControl 같이 "어느 쪽이 선택되어 있는가" 를\n표현해야 하는 상호작용을 Toast 액션 영역에 주입합니다.\n\n규칙:\n- `action` / `cancelAction` 과 mutually exclusive -- 동시 제공 시 기본 버튼 무시.\n- duration 기반 자동 닫힘 비활성 (persistent 강제). 닫기 버튼 또는 `dismiss(id)` 필요.\n- 선택 상태는 caller 가 소유 (여기서는 `useState`). Toast 는 단순 slot.',...g.parameters?.docs?.description}}};const H=["Playground","AllTypes","Persistent","WithActions","CustomDuration","WithTitle","AllStates","MaxCount","WithRenderActions"];export{m as AllStates,l as AllTypes,h as CustomDuration,y as MaxCount,d as Persistent,c as Playground,p as WithActions,g as WithRenderActions,u as WithTitle,H as __namedExportsOrder,Y as default};
